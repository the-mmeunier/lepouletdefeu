...
function readPathCss(filePath) {
    var buffer = fs_1.default.readFileSync(path_1.default.join(__dirname, "./fixtures/", filePath));
    return __1.convertAniBinaryToCSS("#example", buffer).replace(LONG_BASE_64, "$1...");
}
// https://skins.webamp.org/skin/6e30f9e9b8f5719469809785ae5e4a1f/Super_Mario_Amp_2.wsz/
describe("Super_Mario_Amp_2.wsz", function () {
    test("eqslid.cur", function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe("Green Dimension v2.wsz", function () {
    test("eqslid.cur", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
describe("AfterShock_Digital_2003.wsz", function () {
    test("close.cur", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
describe("Edge cases", function () {
    test("piano.ani", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
